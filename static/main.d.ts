...
declare function showNdviChartContainer(): void;
declare function hideNdviChartContainer(): void;
...
declare const ndviMaxLabel: HTMLSpanElement | null;
declare const ndviMidLabel: HTMLSpanElement | null;
declare const ndviMinLabel: HTMLSpanElement | null;
declare function updateNdviColorbar(vmin: number, vmax: number): void;
declare function plotNdviTimeseries(dates: string[], ndvi: number[]): void;
